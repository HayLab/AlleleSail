...
```{r plotting functions, eval = TRUE}
...
```{r fig2 toppanel, fig.height=3, fig.width=6.5}
...
```{r fig2 bottompanel, fig.height=6.7, fig.width=8}
fig_height = #knitr::opts_current$get("fig.height")
fig_width = #knitr::opts_current$get("fig.width")
...
```{r, fig.height=5.9, fig.width=7}
# fig.height=6.7, fig.width=8
...
comb_fig_annotated <- comb_fig + 
  annotate("rect", xmin = x1, xmax = x2, ymin = y2, ymax = y3, 
           fill = rgb(0, 0, 0, alpha = 0), color = 'gray60', linewidth = box_border_size) +
  annotate("rect", xmin = x3, xmax = x4, ymin = y1, ymax = y3, 
           fill = rgb(0, 0, 0, alpha = 0), color = 'gray60', linewidth = box_border_size) +
  annotate("segment", x = x2, xend = x3, y = y2, yend = y1, 
           color = "gray60", linewidth = box_border_size) +
  annotate("segment", x = x2, xend = x3, y = y3, yend = y3, 
           color = "gray60", linewidth = box_border_size)
...
ggsave("figs-7_17/fig_2-Modification_Neutral-Editor.svg", plot = comb_fig_annotated,
       height = fig_height, width = fig_width, units = "mm")
ggsave("figs-7_17/fig_2-Modification_Neutral-Editor.pdf", plot = comb_fig_annotated,
       height = fig_height, width = fig_width, units = "mm")
...
```{r sf1 combined, fig.width = 7, fig.height=5}
legend_height = 0.45 * 7.08661 / 8
...
# og ratio: width 7, height 5

ggsave("figs-7_17/supp-fig_1-DAR_hm.svg", comb_fig_annotated, bg = "white",
       width = 157.5, height = 112.5, units = "mm")
ggsave("figs-7_17/supp-fig_1-DAR_hm.pdf", comb_fig_annotated, bg = "white",
       width = 157.5, height = 112.5, units = "mm")
...
save to figures
```{r sf2 figures, fig.height = 4.5, fig.width = 8}
...
ggsave("figs-7_17/supp-fig_2-DAR_germline_somatic.svg", plot = type_DAR_scaled,
       height = fig_height, width = fig_width, bg = "white", units = "mm")
ggsave("figs-7_17/supp-fig_2-DAR_germline_somatic.pdf", plot = type_DAR_scaled,
       height = fig_height, width = fig_width, bg = "white", units = "mm")
type_DAR_scaled
...
```{r sf3 full figure, fig.height = 6.7, fig.width = 8}
fig_height = knitr::opts_current$get("fig.height")
fig_width = knitr::opts_current$get("fig.width")
...
ggsave("figs-7_17/supp-fig_3-Modification_Neutral-Edit.svg", plot = comb_fig_annotated,
       height = 150.75, width = 180, units = "mm")
ggsave("figs-7_17/supp-fig_3-Modification_Neutral-Edit.pdf", plot = comb_fig_annotated,
       height = 150.75, width = 180, units = "mm")
...
```{r figure 3 full, fig.height = 4 * 7.08661 / 9, fig.width = 7.08661}
fig_height <- knitr::opts_current$get("fig.height")
fig_width <- knitr::opts_current$get("fig.width")
...
fig <- LE_big %>%
  ...
  mutate(fitness = factor(ifelse(fitCost == 0, "Neutral",
                                 ifelse(fitCost < 0, "Fitness Benefit (5%)", "Fitness Cost (5%)")),
                          levels = c("Fitness Benefit (5%)", "Neutral", "Fitness Cost (5%)"))) %>%
...
ggsave("figs-7_17/fig_3-decreased_efficiency-modification.svg", plot = fig2_annot,
       height = fig_height, width = fig_width, units = "mm")
ggsave("figs-7_17/fig_3-decreased_efficiency-modification.pdf", plot = fig2_annot,
       height = fig_height, width = fig_width, units = "mm")
...
```{r sf4 figure, fig.width = 6.2, fig.height = 3.5 * 6.2/7}
...
ggsave("figs-7_17/supp-fig_4-high_iF-LE_modification.svg", plot = fig_fc_3i_annotated,
       height = fig_height, width = fig_width, units = "mm")
ggsave("figs-7_17/supp-fig_4-high_iF-LE_modification.pdf", plot = fig_fc_3i_annotated,
       height = fig_height, width = fig_width, units = "mm")
...
```{r figure 4 full, fig.height=3.6, fig.width=8.25}
...
legend_height <- 0.575 * 7.08661 / 8.25
...
ggsave("figs-7_17/fig_4_linkage-edit_costs.svg", plot = comb_fig_annotated,
       height = fig_height, width = fig_width, units = "mm")
ggsave("figs-7_17/fig_4_linkage-edit_costs.pdf", plot = comb_fig_annotated,
       height = fig_height, width = fig_width, units = "mm")
...
```{r sf5 figure, fig.height = 3.6 * 7.08661 / 8.25, fig.width=7.08661}
fig_height = knitr::opts_current$get("fig.height")
fig_width = knitr::opts_current$get("fig.width")
...
ggsave("figs-7_17/supp-fig_5_WvI_linkage.svg", plot = figure_annotated,
       height = fig_height, width = fig_width, units = "mm")
ggsave("figs-7_17/supp-fig_5_WvI_linkage.pdf", plot = figure_annotated,
       height = fig_height, width = fig_width, units = "mm")
...
edit_p1.2 <- no_legend_plot + annotation_custom(grob = leg2, xmin = 10, xmax = 40, ymin = 0, ymax = 2000)
```

Data for other 5 panels:

```{r figure 5 data panels}
total_pc2 <- read.csv("data/3-5/full_five_noMC_total_pop.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
  separate(Run, c(NA, "iF", NA, "gap", NA, "repeats", "type", "Run"), sep = "_") %>%
...
```{r figure 5 full, fig.height = 7.08661, fig.width = 7.08661}
...
ggsave("figs-7_17/fig_5-single_release-sex_systems.svg", plot = fig_singles, bg = "white",
       height = fig_height, width = fig_width, units = "mm")
ggsave("figs-7_17/fig_5-single_release-sex_systems.pdf", plot = fig_singles, bg = "white",
       height = fig_height, width = fig_width, units = "mm")
...
```{r sf6 full, fig.height=4.7, fig.width=6.5}
fig_height <- 105.75 #knitr::opts_current$get("fig.height")
fig_width <- 146.25 #knitr::opts_current$get("fig.width")
...
ggsave("figs-7_17/supp-fig_6-male_v_female-allele_freq.svg", plot = top_panel,
       height = fig_height, width = fig_width, bg = "white", units = "mm")
ggsave("figs-7_17/supp-fig_6-male_v_female-allele_freq.pdf", plot = top_panel,
       height = fig_height, width = fig_width, bg = "white", units = "mm")
...
```{r sf7 figure, fig.height=6, fig.width=8}
...
ggsave("figs-7_17/supp-fig_7-Zlinked_editor.svg", Z_link_comb)
ggsave("figs-7_17/supp-fig_7-Zlinked_editor.pdf", Z_link_comb)
...
```{r figure 6 data, fig.height = 7.06 * 4/9, fig.width = 7.06}
...
endpoint_fig2 <- rbind(ZW_small, XY_small) %>%
  ...
  scale_fill_viridis(option = "plasma",
                     limits = c(0.23, 0.5585)) +
  labs(x = "Frequency of Old Sex Chromosome (Y or Z)",
       y = "Frequency of New Sex Chromosome (a)",
       title = "Path of Sex Chromosome Turnover",
       shape = "Starting System",
       fill = "Percent Males") +
  theme_light(base_size = 8.6) +
  scale_x_continuous(breaks = c(0.0, 0.25, 0.5, 0.75)) +
  scale_y_continuous(breaks = c(0.0, 0.25, 0.5, 0.75))

#(Intercept)  0.04183    iF           0.75327 

rbind(ZW_small, XY_small) %>%
  filter(Generation %in% c(1, 500)) %>%
  ggplot(aes(x = iF, y = New_Sex)) +
  geom_point() + geom_abline(slope = 0.75327, intercept = 0.04183, color = "red") +
  facet_wrap(~Generation)

select_points <- rbind(ZW_small, XY_small) %>%
  filter(Generation %in% c(1, 500), ((iF*1000) %% 50) == 0) %>%
  #filter((iF %in% c(0.04, 0.735) & Run == 1) | (iF %in% c(0.325, 0.645) & Run == 2)) %>%
  mutate(xgroup = paste(System, Generation, sep = " gen ")) %>%
  ggplot(aes(x = xgroup, y = New_Sex, fill = male_percent, #color = male_percent,
             group = paste(System, iF, Run),
             shape = System)) +
  geom_line() +
  geom_point(size = 3.14) +
  scale_shape_manual(values = c(23, 24)) +
  scale_fill_viridis(option = "plasma",
                     limits = c(0.23, 0.5585)) +
  ...
  labs(title = "",
       x = "Generation",
       y = "Frequency of New Sex Chromosome",
       shape = "Starting System",
       fill = "Percent Males") +
  theme_light(base_size = 8.6) +
  scale_y_continuous(breaks = c(0.0, 0.25, 0.5, 0.75)) +
  scale_x_discrete(labels= c("1", "500", "1", "500"))

twopanel_eq <- ggarrange(endpoint_fig2 + labs(title = ""), select_points, common.legend = TRUE,
                       legend = "right", widths = c(7, 3),
                       labels = c("A", "B"))

twopanel_eq2 <- ggarrange(select_points, endpoint_fig2 + labs(title = ""), common.legend = TRUE,
                       legend = "left", widths = c(3, 7),
                       labels = c("A", "B"))
twopanel_eq2 # save in studio, dimensions are 900 x 400

fig_width = 180
fig_height = 180 * 4/9

ggsave("figs-7_17/fig_6-UNANNOTATED.svg", plot = twopanel_eq2,
       height = fig_height, width = fig_width, bg = "white", units = "mm")
ggsave("figs-7_17/fig_6-UNANNOTATED.pdf", plot = twopanel_eq2,
       height = fig_height, width = fig_width, bg = "white", units = "mm")
```


```{r figure 6 annotated image, eval = FALSE}
text_size = 2.75
arrow_size = 0.8
...
ggsave("figs-7_17/fig_6-endpoint_UNANNOTATED.svg", plot = endpoint_fig2,
       height = fig_height, width = fig_width, bg = "white", units = "mm")
ggsave("figs-7_17/fig_6-endpoint_UNANNOTATED.pdf", plot = endpoint_fig2,
       height = fig_height, width = fig_width, bg = "white", units = "mm")

#ggsave("figs-7_17/fig_6-endpoint_equilibrium.svg", plot = sdf_annotated,
#       height = fig_height, width = fig_width, bg = "white")
#ggsave("figs-7_17/fig_6-endpoint_equilibrium.pdf", plot = sdf_annotated,
#       height = fig_height, width = fig_width, bg = "white")
...
```{r sf8 full, fig.height=3, fig.width=6.5}
fig_height <- knitr::opts_current$get("fig.height")
fig_width <- knitr::opts_current$get("fig.width")
...
ggsave("figs-7_17/supp-fig_8-male_v_female-total_pop.svg", plot = sup_fig_8,
       height = fig_height, width = fig_width, bg = "white", units = "mm")
ggsave("figs-7_17/supp-fig_8-male_v_female-total_pop.pdf", plot = sup_fig_8,
       height = fig_height, width = fig_width, bg = "white", units = "mm")
...
```{r figure 7 full, fig.height = 6, fig.width = 6}
...
p1 <- total_pc3 %>% 
  ...
  labs(title = "Average generation of collapse, for each type and introduction frequency",
       ...
       color = "System",
       shape = "System") + theme_light(base_size = 9.6)
...
ggsave("figs-7_17/fig_7-continuous_release-sex_systems.svg", plot = fig7,
       height = 135, width = 135, bg = "white", units = "mm")
ggsave("figs-7_17/fig_7-continuous_release-sex_systems.pdf", plot = fig7,
       height = 135, width = 135, bg = "white", units = "mm")
...
```{r sf9 full, fig.width=7.08661, fig.height=7 * 7.08661 / 8}
...
all_dots_sup_HE <- total_PC_he %>% 
  ...
  labs(title = "Average generation of collapse, for each type and introduction frequency",
       ...
       shape = "Outcome") + theme_light(base_size = 9.6) +
  theme(strip.text.x = element_text(size=12, color = "black", hjust = 0), #, face = "bold"),
          strip.background = element_blank()) +
  scale_color_manual(
    # values = c("#61D3E6","#440154",  "#e32f6c", "#6d2ac7", "black"),
...
ggsave("figs-7_17/supp-fig_9-moderate_efficiencies-suppression.svg", plot = he_suppression_annotated,
       height = 157.5, width = 180, units = "mm")
ggsave("figs-7_17/supp-fig_9-moderate_efficiencies-suppression.pdf", plot = he_suppression_annotated,
       height = 157.5, width = 180, units = "mm")
...
### Supplemental Figure 10 - SSC / suppression with multiple releases in more systems

```{r sf10, fig.height=4, fig.width=8}
fig_height <- 90 #knitr::opts_current$get("fig.height")
fig_width <- 180 #knitr::opts_current$get("fig.width")
...
ggsave("figs-7_17/supp-fig_10-collapse_gens-2.svg", plot = p2,
       height = fig_height, width = fig_width, bg = "white", units = "mm")
ggsave("figs-7_17/supp-fig_10-collapse_gens-2.pdf", plot = p2,
       height = fig_height, width = fig_width, bg = "white", units = "mm")
