...
ggsave("figs-6_11/fig_2-Modification_Neutral-Editor.svg", plot = comb_fig_annotated,
       height = fig_height, width = fig_width)
ggsave("figs-6_11/fig_2-Modification_Neutral-Editor.png", plot = comb_fig_annotated,
       height = fig_height, width = fig_width)
...
ggsave("figs-6_11/supp-fig_1-DAR_hm.svg", comb_fig_annotated, bg = "white",
       width = 7, height = 5)
ggsave("figs-6_11/supp-fig_1-DAR_hm.png", comb_fig_annotated, bg = "white",
       width = 7, height = 5)
...
ggsave("figs-6_11/supp-fig_2-DAR_germline_somatic.svg", plot = type_DAR_scaled,
       height = fig_height, width = fig_width, bg = "white")
ggsave("figs-6_11/supp-fig_2-DAR_germline_somatic.png", plot = type_DAR_scaled,
       height = fig_height, width = fig_width, bg = "white")
type_DAR_scaled
...
ggsave("figs-6_11/supp-fig_3-Modification_Neutral-Edit.svg", plot = comb_fig_annotated,
       height = 6.7, width = 8)
ggsave("figs-6_11/supp-fig_3-Modification_Neutral-Edit.png", plot = comb_fig_annotated,
       height = 6.7, width = 8)
...
ggsave("figs-6_11/fig_3-decreased_efficiency-modification.svg", plot = fig2_annot,
       height = fig_height, width = fig_width)
ggsave("figs-6_11/fig_3-decreased_efficiency-modification.png", plot = fig2_annot,
       height = fig_height, width = fig_width)
...
ggsave("figs-6_11/supp-fig_4-high_iF-LE_modification.svg", plot = fig_fc_3i_annotated,
       height = fig_height, width = fig_width)
ggsave("figs-6_11/supp-fig_4-high_iF-LE_modification.png", plot = fig_fc_3i_annotated,
       height = fig_height, width = fig_width)
...
ggsave("figs-6_11/fig_4_linkage-edit_costs.svg", plot = comb_fig_annotated,
       height = fig_height, width = fig_width)
ggsave("figs-6_11/fig_4_linkage-edit_costs.png", plot = comb_fig_annotated,
       height = fig_height, width = fig_width)
...
ggsave("figs-6_11/supp-fig_5_WvI_linkage.svg", plot = figure_annotated,
       height = fig_height, width = fig_width)
ggsave("figs-6_11/supp-fig_5_WvI_linkage.png", plot = figure_annotated,
       height = fig_height, width = fig_width)
...
ggsave("figs-6_11/fig_5-single_release-sex_systems.svg", plot = fig_singles, bg = "white",
       height = fig_height, width = fig_width)
ggsave("figs-6_11/fig_5-single_release-sex_systems.png", plot = fig_singles, bg = "white",
       height = fig_height, width = fig_width)
...
ggsave("figs-6_11/supp-fig_6-male_v_female-allele_freq.svg", plot = top_panel,
       height = fig_height, width = fig_width, bg = "white")
ggsave("figs-6_11/supp-fig_6-male_v_female-allele_freq.png", plot = top_panel,
       height = fig_height, width = fig_width, bg = "white")
...
ggsave("figs-6_11/supp-fig_7-Zlinked_editor.svg", Z_link_comb)
ggsave("figs-6_11/supp-fig_7-Zlinked_editor.png", Z_link_comb)
...
endpoint_startpoint <- rbind(ZW_small, XY_small) %>%
  filter(Generation == 500) %>% 
  mutate(outline = ifelse(male_percent == 0.5,
      #filter((iF %in% c(0.04, 0.735) & Run == 1) | (iF %in% c(0.325, 0.645) & Run == 2)) %>%
      "a", "b")) %>%
  arrange(desc(outline)) %>%
  ggplot(aes(x = Old_Sex, y = New_Sex,
             group = interaction(Run, Generation, System),
             fill = male_percent,
             color = outline,
             shape = System)) +
  geom_point(size = 2.2, stroke = 1.0) + 
  scale_shape_manual(values = c(23, 24)) +
  scale_fill_viridis(option = "plasma") +
  scale_color_manual(values = c("#61D3E6", "black"), guide = FALSE) +
  labs(x = "Frequency of Old Sex Chromosome (Y or Z)",
       y = "Frequency of New Sex Chromosome\n(Knockedout Aromatase)",
       title = " ",
       shape = "Starting System",
       fill = "Percent Males") +
  theme_light() +
...
## get iF's
random_subset <- rbind(ZW_small, XY_small) %>% #filter(Generation > 450, System == "XY", Generation > 450) %>% select(iF) %>% unique()
  #filter(Generation == 500, male_percent > 0.49, male_percent < 0.51) %>%
  filter(Run == 1, Generation > 5) %>% #, male_percent > 0.49, male_percent < 0.51) %>%
  filter(iF %in% c(0.05, 0.325, 0.75)) %>%
  ggplot(aes(x = Old_Sex, y = New_Sex,
             group = interaction(Run, Generation, System),
             fill = Generation,
             shape = System)) +
  geom_point(size = 2.2) + 
  facet_wrap(~iF, ncol = 3) +
  scale_shape_manual(values = c(23, 24)) +
  scale_fill_viridis(option = "plasma") +
  labs(x = "Frequency of Old Sex Chromosome (Y or Z)",
       y = "Frequency of New Sex Chromosome (a)",
       title = "Path of Sex Chromosome Turnover",
       shape = "Starting System",
       fill = "Starting Introduction Frequency") +
  theme_light() +
  scale_x_continuous(breaks = c(0.0, 0.25, 0.5, 0.75)) +
  scale_y_continuous(breaks = c(0.0, 0.25, 0.5, 0.75))

sex_v_time <- rbind(ZW_small, XY_small) %>%
  filter(Run == 1, iF %in% c(0.05, 0.325, 0.75)) %>%
  ggplot(aes(x = Generation, y = New_Sex, group = paste(iF, Run, System), color = male_percent)) +
  geom_line() + geom_point() +
  scale_color_viridis(option = "plasma") +
  facet_wrap(~System) +
  labs(y = "Percent of New Sex Chromosome (a)",
       color = "Percent Males")

gen500 <- rbind(ZW_small, XY_small) %>%
  filter(Generation %in% c(500))
model = lm(New_Sex~iF, data = gen500) 
summary(model)
...
rbind(ZW_small, XY_small) %>%
  filter(Generation %in% c(1, 500), ((iF*1000) %% 50) == 0) %>% select(iF) %>% unique()
...
ggsave("figs-6_11/fig_6-endpoint_UNANNOTATED.svg", plot = endpoint_fig2,
       height = fig_height, width = fig_width, bg = "white")
ggsave("figs-6_11/fig_6-endpoint_UNANNOTATED.png", plot = endpoint_fig2,
       height = fig_height, width = fig_width, bg = "white")

#ggsave("figs-6_11/fig_6-endpoint_equilibrium.svg", plot = sdf_annotated,
#       height = fig_height, width = fig_width, bg = "white")
#ggsave("figs-6_11/fig_6-endpoint_equilibrium.png", plot = sdf_annotated,
#       height = fig_height, width = fig_width, bg = "white")
...
ggsave("figs-6_11/supp-fig_8-male_v_female-total_pop.svg", plot = sup_fig_8,
       height = fig_height, width = fig_width, bg = "white")
ggsave("figs-6_11/supp-fig_8-male_v_female-total_pop.png", plot = sup_fig_8,
       height = fig_height, width = fig_width, bg = "white")
...
ggsave("figs-6_11/fig_7-continuous_release-sex_systems.svg", plot = fig7,
       height = 6, width = 6, bg = "white")
ggsave("figs-6_11/fig_7-continuous_release-sex_systems.png", plot = fig7,
       height = 6, width = 6, bg = "white")
...
ggsave("figs-6_11/supp-fig_9-moderate_efficiencies-suppression.svg", plot = he_suppression_annotated,
       height = 7, width = 8)
ggsave("figs-6_11/supp-fig_9-moderate_efficiencies-suppression.png", plot = he_suppression_annotated,
       height = 7, width = 8)
...
ggsave("figs-6_11/supp-fig_10-collapse_gens-2.svg", plot = p2,
       height = fig_height, width = fig_width, bg = "white")
ggsave("figs-6_11/supp-fig_10-collapse_gens-2.png", plot = p2,
       height = fig_height, width = fig_width, bg = "white")
