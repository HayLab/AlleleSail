...
```{r}
gmcwithSail_allele2 <- read.csv("alleleSail_data/1-11/EvI/introFreq_0.100_NEWallele.csv") %>%
  clean() %>%
  transform(Scost = introFreq, introFreq = fitCost) %>% select(-fitCost) %>%
  mutate(type = "with Sail")

gmcwithSail_total_ds2 <- read.csv("alleleSail_data/1-11/EvI/introFreq_0.100_total.csv") %>%
  clean() %>%
  transform(Scost = introFreq, introFreq = fitCost) %>% select(-fitCost)%>%
...
gmcnoSail_allele2 <- read.csv("alleleSail_data/1-11/noSail_modification_MC_NEWallele.csv") %>%
  clean() %>%
  transform(Scost = introFreq, introFreq = fitCost) %>% select(-fitCost) %>%
  filter(introFreq == 0.1, Scost %in% c(0.05, 0.00, -0.05), Allele == "E") %>%
  mutate(type = "no Sail")

gmcnoSail_total_ds2 <- read.csv("alleleSail_data/1-11/noSail_modification_MC_total.csv") %>%
  clean() %>%
  transform(Scost = introFreq, introFreq = fitCost) %>% select(-fitCost)%>%
  group_by(Generation, introFreq, Scost, Run) %>%
  summarise(totalPop = sum(Count)) %>%
...
EvI_O <- read.csv("alleleSail_data/1-11/EvI/last_gen_O_carrier.csv") %>%
  mutate(fitCost = fitCost * 2)

EvI_E <- read.csv("alleleSail_data/1-11/EvI/last_gen_E_carrier.csv") %>%
  mutate(fitCost = fitCost * 2)
...
ggsave("fig_2-Modification_Neutral-Editor.svg", plot = comb_fig_annotated,
       height = fig_height, width = fig_width)
ggsave("fig_2-Modification_Neutral-Editor.png", plot = comb_fig_annotated,
       height = fig_height, width = fig_width)
...
rec_total_hm <- get_DAR_Sail_hm("alleleSail_data/3-11/Sail_modification_MC_rec_total.csv", "recessive") %>%
  mutate(totalPop = Count) %>% select(-Count) %>%
  group_by(Generation, introFreq, Ecost, Run, type) %>%
  mutate(totalPop = sum(totalPop))

rec_alleles_hm <- get_DAR_Sail_hm("alleleSail_data/3-11/Sail_modification_MC_rec_allele.csv", "recessive")

add_total_hm <- get_DAR_Sail_hm("alleleSail_data/3-11/Sail_modification_MC_add_total.csv", "additive") %>%
  mutate(totalPop = Count) %>% select(-Count) %>%
  group_by(Generation, introFreq, Ecost, Run, type) %>%
  mutate(totalPop = sum(totalPop))
  
add_alleles_hm <- get_DAR_Sail_hm("alleleSail_data/3-11/Sail_modification_MC_add_allele.csv", "additive")

dom_total_hm <- get_DAR_Sail_hm("alleleSail_data/3-11/Sail_modification_MC_dom_total.csv", "dominant") %>%
  mutate(totalPop = Count) %>% select(-Count) %>%
  group_by(Generation, introFreq, Ecost, Run, type) %>%
  mutate(totalPop = sum(totalPop))
  
dom_alleles_hm <- get_DAR_Sail_hm("alleleSail_data/3-11/Sail_modification_MC_dom_allele.csv", "dominant")
...
```{r}
dom_total <- get_DAR_Sail("alleleSail_data/3-11/Sail_modification_MC_dom_total.csv", "dominant",
                          introFreqs = c(0.025, 0.1, 0.3), fitCosts = c(-0.1, 0.0, 0.1, 0.2))
dom_alleles <- get_DAR_Sail("alleleSail_data/3-11/Sail_modification_MC_dom_NEWallele.csv", "dominant",
                          introFreqs = c(0.025, 0.1, 0.3), fitCosts = c(-0.1, 0.0, 0.1, 0.2))

add_total <- get_DAR_Sail("alleleSail_data/3-11/Sail_modification_MC_add_total.csv", "additive",
                          introFreqs = c(0.025, 0.1, 0.3), fitCosts = c(-0.05, 0.0, 0.05, 0.1)) %>%
  mutate(Ecost = Ecost * 2)
add_alleles <- get_DAR_Sail("alleleSail_data/3-11/Sail_modification_MC_add_NEWallele.csv", "additive",
                          introFreqs = c(0.025, 0.1, 0.3), fitCosts = c(-0.05, 0.0, 0.05, 0.1)) %>%
  mutate(Ecost = Ecost * 2)

rec_total <- get_DAR_Sail("alleleSail_data/3-11/Sail_modification_MC_rec_total.csv", "recessive",
                          introFreqs = c(0.025, 0.1, 0.3), fitCosts = c(-0.1, 0.0, 0.1, 0.2))
rec_alleles <- get_DAR_Sail("alleleSail_data/3-11/Sail_modification_MC_rec_NEWallele.csv", "recessive",
                          introFreqs = c(0.025, 0.1, 0.3), fitCosts = c(-0.1, 0.0, 0.1, 0.2))
...
dom_total <- get_DAR_noSail("alleleSail_data/3-11/noSail_modification_MC_dom_total.csv", "dominant",
                          introFreqs = c(0.025, 0.1, 0.3), fitCosts = c(-0.1, 0.0, 0.1, 0.2))
dom_alleles <- get_DAR_noSail("alleleSail_data/3-11/noSail_modification_MC_dom_NEWallele.csv", "dominant",
                          introFreqs = c(0.025, 0.1, 0.3), fitCosts = c(-0.1, 0.0, 0.1, 0.2))

add_total <- get_DAR_noSail("alleleSail_data/3-11/noSail_modification_MC_add_total.csv", "additive",
                          introFreqs = c(0.025, 0.1, 0.3), fitCosts = c(-0.05, 0.0, 0.05, 0.1)) %>%
  mutate(Ecost = Ecost * 2)
add_alleles <- get_DAR_noSail("alleleSail_data/3-11/noSail_modification_MC_add_NEWallele.csv", "additive",
                          introFreqs = c(0.025, 0.1, 0.3), fitCosts = c(-0.05, 0.0, 0.05, 0.1)) %>%
  mutate(Ecost = Ecost * 2)

rec_total <- get_DAR_noSail("alleleSail_data/3-11/noSail_modification_MC_rec_total.csv", "recessive",
                          introFreqs = c(0.025, 0.1, 0.3), fitCosts = c(-0.1, 0.0, 0.1, 0.2))
rec_alleles <- get_DAR_noSail("alleleSail_data/3-11/noSail_modification_MC_rec_NEWallele.csv", "recessive",
                          introFreqs = c(0.025, 0.1, 0.3), fitCosts = c(-0.1, 0.0, 0.1, 0.2))
...
ggsave("supp-fig_1-DAR_hm.svg", comb_fig_annotated, bg = "white",
       width = 7, height = 5)
ggsave("supp-fig_1-DAR_hm.png", comb_fig_annotated, bg = "white",
       width = 7, height = 5)
...
### Supplemental Figure 2 - Neutral Edit, non-neutral Editor

Figure 2, but for SvI (costs on Wind)
```{r}
gmcwithSail_allele2 <- read.csv("alleleSail_data/1-11/SvI/introFreq_0.100_NEWallele.csv") %>%
  clean() %>%
  transform(Scost = introFreq, introFreq = fitCost) %>% select(-fitCost) %>%
  mutate(type = "with Sail")

gmcwithSail_total_ds2 <- read.csv("alleleSail_data/1-11/SvI/introFreq_0.100_total.csv") %>%
  clean() %>%
  transform(Scost = introFreq, introFreq = fitCost) %>% select(-fitCost)%>%
  group_by(Generation, introFreq, Scost, Run) %>%
  summarise(totalPop = sum(Count)) %>%
...
SvI_O <- read.csv("alleleSail_data/1-11/SvI/last_gen_O_carrier.csv")

SvI_E <- read.csv("alleleSail_data/1-11/SvI/last_gen_E_carrier.csv")
...
ggsave("supp-fig_2-Modification_Neutral-Edit.svg", plot = comb_fig_annotated,
       height = 6.7, width = 8)
ggsave("supp-fig_2-Modification_Neutral-Edit.png", plot = comb_fig_annotated,
       height = 6.7, width = 8)

print("Saved to supp-fig_2-Modification_Neutral-Edit")
```
...
```{r}
#### no MC
no_mc_total_LE <- read.csv("alleleSail_data/2-5/low_efficiencies_noMC_smallRuns_total.csv") %>%
  clean() %>%
...
no_mc_allele_LE <- read.csv("alleleSail_data/2-5/low_efficiencies_noMC_smallRuns_NEWallele.csv") %>%
  clean() %>%
  transform(efficiency = fitCost, fitCost = introFreq) %>% select(-introFreq) %>%
...
#### MC
mc_total_LE <- read.csv("alleleSail_data/2-5/low_efficiencies_MC_smallRuns_total.csv") %>%
  clean() %>%
  transform(efficiency = fitCost, fitCost = introFreq) %>% select(-introFreq) %>%
  group_by(Generation, efficiency, fitCost, Run) %>%
  summarise(totalPop = sum(Count)) %>%
...
mc_allele_LE <- read.csv("alleleSail_data/2-5/low_efficiencies_MC_smallRuns_NEWallele.csv") %>%
  clean() %>%
  transform(efficiency = fitCost, fitCost = introFreq) %>% select(-introFreq) %>%
  group_by(Generation, efficiency, fitCost, Allele, Run) %>%
  summarise(Allele_Count = sum(Count)) %>%
...
ggsave("fig_3-decreased_efficiency-modification.svg", plot = fig2_annot,
       height = fig_height, width = fig_width)
ggsave("fig_3-decreased_efficiency-modification.png", plot = fig2_annot,
       height = fig_height, width = fig_width)
...
### Supplemental Figure 3 - Decreased Efficiency, Increased Introduction Frequency, and Modification

compare sail vs. no sail data - 20% intro
```{r}
#### no MC
no_mc_total_LE_i20 <- read.csv("alleleSail_data/2-23/low_efficiencies_int_20_noMC_smallRuns_total.csv") %>%
  clean() %>%
  transform(efficiency = fitCost, fitCost = introFreq) %>% select(-introFreq) %>%
...
no_mc_allele_LE_i20 <- read.csv("alleleSail_data/2-23/low_efficiencies_int_20_noMC_smallRuns_NEWallele.csv") %>%
  clean() %>%
  transform(efficiency = fitCost, fitCost = introFreq) %>% select(-introFreq) %>%
  filter(Allele == "E", fitCost %in% c(-0.05, 0, 0.05)) %>%
  group_by(Generation, efficiency, fitCost, Allele, Run) %>%
...
#### MC
mc_total_LE_i20 <- read.csv("alleleSail_data/2-23/low_efficiencies_int_20_MC_smallRuns_total.csv") %>%
  clean() %>%
  transform(efficiency = fitCost, fitCost = introFreq) %>% select(-introFreq) %>%
  filter(fitCost %in% c(-0.05, 0, 0.05)) %>%
  group_by(Generation, efficiency, fitCost, Run) %>%
...
mc_allele_LE_i20 <- read.csv("alleleSail_data/2-23/low_efficiencies_int_20_MC_smallRuns_NEWallele.csv") %>%
  clean() %>%
  transform(efficiency = fitCost, fitCost = introFreq) %>% select(-introFreq) %>%
  filter(Allele == "E", fitCost %in% c(-0.05, 0, 0.05)) %>%
  group_by(Generation, efficiency, fitCost, Allele, Run) %>%
...
```{r}
#### no MC
no_mc_total_LE_i40 <- read.csv("alleleSail_data/2-23/low_efficiencies_int_40_noMC_smallRuns_total.csv") %>%
  clean() %>%
  transform(efficiency = fitCost, fitCost = introFreq) %>% select(-introFreq) %>%
  filter(fitCost %in% c(-0.05, 0, 0.05)) %>%
  group_by(Generation, efficiency, fitCost, Run) %>%
...
no_mc_allele_LE_i40 <- read.csv("alleleSail_data/2-23/low_efficiencies_int_40_noMC_smallRuns_NEWallele.csv") %>%
  clean() %>%
  transform(efficiency = fitCost, fitCost = introFreq) %>% select(-introFreq) %>%
  filter(Allele == "E", fitCost %in% c(-0.05, 0, 0.05)) %>%
  group_by(Generation, efficiency, fitCost, Allele, Run) %>%
...
#### MC
mc_total_LE_i40 <- read.csv("alleleSail_data/2-23/low_efficiencies_int_40_MC_smallRuns_total.csv") %>%
  clean() %>%
  transform(efficiency = fitCost, fitCost = introFreq) %>% select(-introFreq) %>%
  filter(fitCost %in% c(-0.05, 0, 0.05)) %>%
  group_by(Generation, efficiency, fitCost, Run) %>%
...
mc_allele_LE_i40 <- read.csv("alleleSail_data/2-23/low_efficiencies_int_40_MC_smallRuns_NEWallele.csv") %>%
  clean() %>%
  transform(efficiency = fitCost, fitCost = introFreq) %>% select(-introFreq) %>%
  filter(Allele == "E", fitCost %in% c(-0.05, 0, 0.05)) %>%
  group_by(Generation, efficiency, fitCost, Allele, Run) %>%
...
```{r}
percent_10 <- LE_big %>% filter(fitCost > 0) %>% mutate(intro = "10% introduction")
...
ggsave("supp-fig_3-high_iF-LE_modification.svg", plot = fig_fc_3i_annotated,
       height = fig_height, width = fig_width)
ggsave("supp-fig_3-high_iF-LE_modification.png", plot = fig_fc_3i_annotated,
       height = fig_height, width = fig_width)

print("Saved to supp-fig_3-high_iF-LE_modification")
```
...
rd0_E <- read.csv("alleleSail_data/2-5/rd_0-clvg_0.5_last_gen_E.csv", 
                header = FALSE,
                col.names = c("Count","Sex","fitCost","run","introFreq","totalPop")) %>%
  mutate(rd = "linked")
rd50_E <- read.csv("alleleSail_data/2-5/rd_50-clvg_0.5_last_gen_E.csv", 
                header = FALSE,
                col.names = c("Count","Sex","fitCost","run","introFreq","totalPop")) %>%
  mutate(rd = "unlinked")
...
ggsave("fig_4_linkage-edit_costs.svg", plot = comb_fig_annotated,
       height = fig_height, width = fig_width)
ggsave("fig_4_linkage-edit_costs.png", plot = comb_fig_annotated,
       height = fig_height, width = fig_width)
...
### Supplemental Figure 4 - Linkage, costs on editor
...
### E's for amount E's ###
rd0_E <- read.csv("alleleSail_data/2-5/svi_rd_0-clvg_0.5_last_gen_E.csv", 
                header = FALSE,
                col.names = c("Count","Sex","fitCost","run","introFreq","totalPop")) %>%
  mutate(rd = "linked")
rd50_E <- read.csv("alleleSail_data/2-5/svi_rd_50-clvg_0.5_last_gen_E.csv", 
                header = FALSE,
                col.names = c("Count","Sex","fitCost","run","introFreq","totalPop")) %>%
  mutate(rd = "unlinked")
...
ggsave("supp-fig_4_WvI_linkage.svg", plot = figure_annotated,
       height = fig_height, width = fig_width)
ggsave("supp-fig_4_WvI_linkage.png", plot = figure_annotated,
       height = fig_height, width = fig_width)

print("Saved to supp-fig_4_WvI_linkage")
```
...
```{r}
total_pc2 <- read.csv("alleleSail_data/3-5/full_five_noMC_total_pop.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
...
allele2 <- read.csv("alleleSail_data/3-5/full_five_noMC_NEWallele.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
  separate(Run, c(NA, "iF", NA, "gap", NA, "repeats", "type", "Run"), sep = "_") %>%
...
ggsave("fig_5-single_release-sex_systems.svg", plot = fig_singles, bg = "white",
       height = fig_height, width = fig_width)
ggsave("fig_5-single_release-sex_systems.png", plot = fig_singles, bg = "white",
       height = fig_height, width = fig_width)
...
### Supplemental Figure 5 - Editor segregates to Males

```{r, fig.height=4.7, fig.width=6.5}
fig_height <- knitr::opts_current$get("fig.height")
fig_width <- knitr::opts_current$get("fig.width")

stotal_pc2 <- read.csv("alleleSail_data/3-5/full_five_noMC_total_pop.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
  separate(Run, c(NA, "iF", NA, "gap", NA, "repeats", "type", "Run"), sep = "_") %>%
  transform(Generation = as.numeric(Generation), Count = as.numeric(Count)) %>%
...
sallele2 <- read.csv("alleleSail_data/3-5/full_five_noMC_NEWallele.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
  separate(Run, c(NA, "iF", NA, "gap", NA, "repeats", "type", "Run"), sep = "_") %>%
  transform(Generation = as.numeric(Generation), Count = as.numeric(Count)) %>%
...
ggsave("supp_fig_5-male_v_female-allele_freq.svg", plot = top_panel,
       height = fig_height, width = fig_width, bg = "white")
ggsave("supp_fig_5-male_v_female-allele_freq.png", plot = top_panel,
       height = fig_height, width = fig_width, bg = "white")

print("Saved to supp_fig_5-male_v_female-allele_freq")
```


### Supplemental Figure 6 - Z-linked Editor

Get Multiple Releases Info

```{r}
zw_gen_noMC_a <- read.csv("alleleSail_data/2-23/ais_51releases_noMC_NEWallele.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
...
zw_gen_noMC_tp <- read.csv("alleleSail_data/2-23/ais_51releases_noMC_total_pop.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
  separate(Run, c(NA, "iF", NA, "rd", NA, "efficiency", NA, "repeats", "type", "Run"), sep = "_") %>%
  filter(iF %in% c(0.05, 0.1)) %>%
...
zwwind_gen_noMC_a <- read.csv("alleleSail_data/2-23/ais_ZW_ZWind_noMC_NEWallele.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
  separate(Run, c(NA, "iF", NA, "rd", NA, "efficiency", NA, "repeats", "type", "Run"), sep = "_") %>%
  filter(iF %in% c(0.05, 0.1)) %>%
...
zwwind_gen_noMC_tp <- read.csv("alleleSail_data/2-23/ais_ZW_ZWind_noMC_total_pop.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
  separate(Run, c(NA, "iF", NA, "rd", NA, "efficiency", NA, "repeats", "type", "Run"), sep = "_") %>%
  filter(iF %in% c(0.05, 0.1)) %>%
...
total_pc2_noMC <- read.csv("alleleSail_data/3-5/full_five_noMC_total_pop.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
  separate(Run, c(NA, "iF", NA, "gap", NA, "repeats", "type", "Run"), sep = "_") %>%
  transform(Generation = as.numeric(Generation), Count = as.numeric(Count)) %>%
...
ZW_noMC_singleRel <- read.csv("alleleSail_data/3-11/ZW_Zwind_singleRelease_noMC_total_pop.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
  separate(Run, c(NA, "iF", NA, "rd", NA, "efficiency", NA, "repeats", "type", "Run"), sep = "_") %>%
  transform(Generation = as.numeric(Generation), Count = as.numeric(Count)) %>%
...
ggsave("supp-fig_6-Zlinked_editor.svg", Z_link_comb)
ggsave("supp-fig_6-Zlinked_editor.png", Z_link_comb)

print("Saved to supp-fig_6-Zlinked_editor")
```
...
endpoint_fig2 <- rbind(ZW_small, XY_small) %>%
  ...
  labs(x = "Frequency of Old Sex Chromosome (Y or Z)",
       ...
       title = "Path of Neutral Equilibrium",
...
sdf_annotated <- endpoint_fig2 +
  ...
  annotate("text", size = text_size, hjust = 0,
           x = 0.3, y = 0.1, 
           label = ": XY No Sail / No Sail\n: XX No Sail / No Sail") +
  annotate("text", size = text_size, hjust = 0,
           x = 0.28, y = 0.1, label = "♂\n♀") +
  annotate("text", size = text_size, hjust = 0,
           x = 0.51, y = 0.2, 
           label = ": ZZ No Sail / No Sail\n: ZW No Sail / No Sail") +
  annotate("text", size = text_size, hjust = 0,
           x = 0.49, y = 0.2, label = "♂\n♀") +
...
ggsave("fig_6-endpoint_equilibrium.svg", plot = sdf_annotated,
       height = fig_height, width = fig_width, bg = "white")
ggsave("fig_6-endpoint_equilibrium.png", plot = sdf_annotated,
       height = fig_height, width = fig_width, bg = "white")
...
### Supplemental Figure 7 - Number of Males vs. Females
...
sup_fig_7 <- ggarrange(supA, supB, ncol = 2,
          labels = c("A", "B"),
          common.legend = TRUE, legend = "right")

ggsave("supp-fig_7-male_v_female-total_pop.svg", plot = sup_fig_7,
       height = fig_height, width = fig_width, bg = "white")
ggsave("supp_fig_7-male_v_female-total_pop.png", plot = sup_fig_7,
       height = fig_height, width = fig_width, bg = "white")

sup_fig_7

print("Saved to supp-fig_7-male_v_female-total_pop")
```
...
```{r}
total_pc3 <- read.csv("alleleSail_data/2-23/ais_51releases_noMC_total_pop.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
  separate(Run, c(NA, "iF", NA, "rd", NA, "efficiency", NA, "repeats", "type", "Run"), sep = "_") %>%
  transform(Generation = as.numeric(Generation), Count = as.numeric(Count)) %>%
...
ggsave("fig_7-continuous_release-sex_systems.svg", plot = fig7,
       height = 6, width = 6, bg = "white")
ggsave("fig_7-continuous_release-sex_systems.png", plot = fig7,
       height = 6, width = 6, bg = "white")
...
### Supplemental Figure 8 - lower efficiency, XY and ZW vs. fsRIDL

```{r, fig.width=8, fig.height=7}
total_PC_he <- read.csv("alleleSail_data/2-23/51releases_highEfficiencies_2_total_pop.csv") %>%
  filter(Generation != "Generation") %>%
  select(-X) %>%
  separate(Run, c(NA, "iF", NA, "rd", NA, "efficiency", NA, "repeats", "type", "Run"), sep = "_") %>%
...
ggsave("supp-fig_8-moderate_efficiencies-suppression.svg", plot = he_suppression_annotated,
       height = 7, width = 8)
ggsave("supp-fig_8-moderate_efficiencies-suppression.png", plot = he_suppression_annotated,
       height = 7, width = 8)

print("saved to supp-fig_8-moderate_efficiencies-suppression")
```
...
ggsave("supp-fig_9-collapse_gens-2.svg", plot = p2,
       height = fig_height, width = fig_width, bg = "white")
ggsave("supp-fig_9-collapse_gens-2.png", plot = p2,
       height = fig_height, width = fig_width, bg = "white")

print("Saved to supp-fig_9-collapse_gens-2.svg")
```
