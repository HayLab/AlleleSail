...
### Supplemental Figure 3.1 - Decreased Efficiency, Increased Introduction Frequency, and Modification
...
ggsave("fig_le_modification_ibig.svg", plot = fig_fc_3i_annotated,
       height = fig_height, width = fig_width)
ggsave("fig_le_modification_ibig.png", plot = fig_fc_3i_annotated,
       height = fig_height, width = fig_width)
```
...
### Supplemental Figure 3 - Linkage, costs on editor
...
ggsave("supp-fig_3_WvI_linkage.svg", plot = figure_annotated,
       height = fig_height, width = fig_width)
ggsave("supp-fig_3_WvI_linkage.png", plot = figure_annotated,
       height = fig_height, width = fig_width)

print("Saved to supp-fig_3_WvI_linkage")
```
...
### Supplemental Figure 4 - Number of Males vs. Females
...
sup_fig_5 <- ggarrange(supA, supB, ncol = 2,
          labels = c("A", "B"),
          common.legend = TRUE, legend = "right")

ggsave("supp-fig_4-male_v_female-total_pop.svg", plot = sup_fig_5,
       height = fig_height, width = fig_width, bg = "white")
ggsave("supp_fig_4-male_v_female-total_pop.png", plot = sup_fig_5,
       height = fig_height, width = fig_width, bg = "white")

sup_fig_5

print("Saved to supp-fig_4-male_v_female-total_pop")
```
...
### Supplemental Figure 5 - lower efficiency, XY and ZW vs. fsRIDL
...
ggsave("supp-fig_5-moderate_efficiencies-suppression.svg", plot = he_suppression_annotated) #,height = fig_height, width = fig_width)
ggsave("supp-fig_5-moderate_efficiencies-suppression.png", plot = he_suppression_annotated) #, height = fig_height, width = fig_width)

print("saved to supp-fig_5-moderate_efficiencies-suppression")
```



### Supplemental Figure 6 - SSC / suppression with multiple releases in more systems
...
ggsave("supp-fig_6-collapse_gens-2.svg", plot = p2,
       height = fig_height, width = fig_width, bg = "white")
ggsave("supp-fig_6-collapse_gens-2.png", plot = p2,
       height = fig_height, width = fig_width, bg = "white")

print("Saved to supp-fig_6-collapse_gens-2.svg")
```
